...
export { default as WagashiIcon } from "./Icons/Wagashi";
export { default as WagashiRoundIcon } from "./Icons/WagashiRound";
...
export { default as ProgressWagashi } from "./Icons/ProgressWagashi";
